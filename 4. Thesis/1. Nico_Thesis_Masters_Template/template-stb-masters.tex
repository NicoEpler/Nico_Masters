...
\title{\bfseries
       \AorE{%-- Afrikaans ------------------------------------------
             ...
             Quadrotor for Underground Mine Mapping And Exploration}}

\author{N.\ Epler}{Nico Epler}

\degree{\AorE{MIng (Meg)}{MEng (Elec)}}
...
\address{\AorE{%-- Afrikaans ----------------------------------------
        ...
        Department of Electric and Electronnis Engineering,\\
...
\include{chaps-front/chap-abstract}
